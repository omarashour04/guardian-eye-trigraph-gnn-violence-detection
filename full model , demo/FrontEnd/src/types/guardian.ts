...
export type GuardianGateValidity = {
  status: "valid" | "partial" | "unknown"
  message: string
  raw_gate_sum: number
  active_gate_sum: number
  inactive_gate_sum: number
  unavailable_contributions: string[]
}
...
export type GuardianMedia = {
  ...
  overlay_status?: Partial<
    Record<
      ...
      "available" | "missing" | "generating" | "fallback_placeholder"
    >
  >
  cache_key?: string
  source: string
...
export type GuardianExplanation = {
  ...
  narration_mode?: "vlm_llm" | "vlm_only" | "fallback"
...
export type GuardianLegalConsequencesRag = {
  ...
  legal_mode?: "llm" | "curated_fallback"
...
export type GuardianAskResponse = {
  ...
  confidence: number
  ask_mode?: "llm" | "fallback" | "grounded"
...
export type GuardianPrediction = {
  ...
  gate_validity?: GuardianGateValidity
  gqs: GuardianGqs
